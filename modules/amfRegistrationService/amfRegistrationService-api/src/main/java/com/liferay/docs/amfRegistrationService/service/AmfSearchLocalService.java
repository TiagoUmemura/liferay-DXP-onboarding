...
public interface AmfSearchLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AmfSearchLocalServiceUtil} to access the amf search local service. Add custom service methods to {@link com.liferay.docs.amfRegistrationService.service.impl.AmfSearchLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AmfSearch addAmfSearch(AmfSearch amfSearch);
	...
	*/
	public AmfSearch createAmfSearch(long amfSearchField);
	...
	*/
	...
	public AmfSearch deleteAmfSearch(AmfSearch amfSearch);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AmfSearch deleteAmfSearch(long amfSearchField)
	...
	*/
	...
	public AmfSearch fetchAmfSearch(long amfSearchField);

	public void findByZip();

	public List<AmfUserSearchDTO> findUserByZipCode(java.lang.String zipCode,
		int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AmfSearch getAmfSearch(long amfSearchField)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AmfSearch> getAmfSearchs(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AmfSearch updateAmfSearch(AmfSearch amfSearch);
}